...
public interface IUserStatsService
{
    ...
    /// <summary>
    /// Retrieves all user statistics records.
    /// </summary>
    Task<List<UserStats>> GetAllAsync(CancellationToken ct = default);

    /// <summary>
    /// Persists a new user stats record and returns the new identifier.
    /// </summary>
    Task<int> InsertAsync(UserStats userStats, CancellationToken ct = default);

    /// <summary>
    /// Updates an existing user stats record.
    /// </summary>
    Task<bool> UpdateAsync(UserStats userStats, CancellationToken ct = default);

    /// <summary>
    /// Removes a user stats record from the system.
    /// </summary>
    Task<bool> DeleteAsync(int id, CancellationToken ct = default);

    /// <summary>
    /// Retrieves all user statistics ordered for leaderboard display.
    /// </summary>
