...
namespace MovieApp.WebApi.Migrations
{
    ...
    [Migration("20260526192854_FixUserSpinDataKey")]
    partial class FixUserSpinDataKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieApp.DataLayer.Models.FavoriteEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieApp.DataLayer.Models.UserSpinData", b =>
                {
                    b.HasOne("MovieApp.DataLayer.Models.User", null)
                        .WithOne()
                        .HasForeignKey("MovieApp.DataLayer.Models.UserSpinData", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
