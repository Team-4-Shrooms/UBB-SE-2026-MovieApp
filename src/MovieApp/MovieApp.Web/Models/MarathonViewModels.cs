...
public sealed class MarathonListItemViewModel
{
    ...
    public int ProgressPercent => TotalMovies <= 0
        ? 0
        : (int)Math.Round(100.0 * CompletedMovies / TotalMovies);
}
...
public sealed class MarathonDetailViewModel
{
    ...
    public bool IsJoined => Progress is not null;
    ...
    public int CompletedMovies => Progress?.CompletedMoviesCount ?? 0;
