...
namespace MovieApp.DataLayer.Repositories
{
    public sealed class BookingRepository : IBookingRepository
    {
        ...
        public BookingRepository(IMovieAppDbContext context) => this.context = context;
        ...
        public async Task<bool> ReserveAsync(int screeningId, int userId, IReadOnlyList<(int Row, int Column)> seats, CancellationToken ct = default)
        {
            ...
            await using var tx = await ((DbContext)this.context).Database.BeginTransactionAsync(ct);
        ...
        Task<IReadOnlyList<Booking>> IBookingRepository.GetByScreeningAsync(int screeningId, CancellationToken cancellationToken)
        {
